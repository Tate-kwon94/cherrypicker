...
const cosmetics: Cosmetic[] = [
  {
    id: "cicaplast",
    catalogId: "lrp-cicaplast-balm-b5",
    brand: "라로슈포제",
    name: "시카플라스트 밤 B5",
    image: "/products/lrp-cicaplast-balm-b5.png",
    imageAlt: "라로슈포제 시카플라스트 밤 B5 제품",
    imageSource: "https://www.larocheposay.co.kr/product/view/4247.do",
    unit: "ml",
    dutyVolume: 100,
    retailVolume: 100,
    dutyPrice: 38202,
    retailBasePrice: 41000,
    shipping: 2500,
  ...
  {
    id: "hyalu",
    catalogId: "lrp-hyalu-b5-serum",
    brand: "라로슈포제",
    name: "히알루 B5 세럼",
    image: "/products/lrp-hyalu-b5-serum.png",
    imageAlt: "라로슈포제 히알루 B5 세럼 제품",
    imageSource: "https://www.larocheposay.co.kr/product/view/4794.do",
    unit: "ml",
    // 면세는 50ml 점보, 국내 본품은 30ml — 단위가로 비교한다.
    dutyVolume: 50,
    retailVolume: 30,
    dutyPrice: 68000,
    retailBasePrice: 55000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  // ── 2026-08-30 확대 1차: 롯데·현대 상품 페이지 검증 완료 상품 ──
  // 시슬리(에뮐씨옹 에꼴로지끄)는 파일럿에만 있고 화면 카드는 보류 —
  // 공식 이미지를 아직 확보하지 못했다(사이트 봇 차단).
    // 면세 100ml vs 국내 본품 50ml — 단위가 비교
  {
    id: "genifique",
    catalogId: "lancome-genifique-ultimate",
    brand: "랑콤",
    name: "제니피끄 얼티미트 세럼",
    image: "/products/lancome-genifique-ultimate.jpg",
    imageAlt: "랑콤 제니피끄 얼티미트 세럼 제품",
    imageSource:
      "https://www.lancome.co.kr/kr/%EC%8A%A4%ED%82%A8%EC%BC%80%EC%96%B4/%EC%A0%9C%ED%92%88-%EB%9D%BC%EC%9D%B8%EB%B3%84/%EC%A0%9C%EB%8B%88%ED%94%BC%EB%81%84/A03611-LAC.html",
    unit: "ml",
    dutyVolume: 100,
    retailVolume: 50,
    dutyPrice: 249834,
    retailBasePrice: 200000,
    shipping: 3000,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "lamer",
    catalogId: "lamer-creme-de-la-mer",
    brand: "라메르",
    name: "크렘 드 라 메르",
    image: "/products/lamer-creme-de-la-mer.png",
    imageAlt: "라메르 크렘 드 라 메르 제품",
    imageSource:
      "https://www.lamerkorea.com/product/5834/12343/face/moisturizers/-/-",
    unit: "ml",
    dutyVolume: 60,
    retailVolume: 60,
    dutyPrice: 513471,
    retailBasePrice: 600000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
    ...
    // 면세 125ml 점보 vs 국내 본품 50ml
  {
    id: "kiehlsufc",
    catalogId: "kiehls-ultra-facial-cream",
    brand: "키엘",
    name: "울트라 훼이셜 크림",
    image: "/products/kiehls-ultra-facial-cream.jpg",
    imageAlt: "키엘 울트라 훼이셜 크림 제품",
    imageSource:
      "https://www.kiehls.co.kr/kr/%ED%82%A4%EC%97%98-%EC%88%98%EB%B6%84-%EC%9E%A5%EB%B2%BD-%ED%81%AC%EB%A6%BC/622.html",
    unit: "ml",
    dutyVolume: 125,
    retailVolume: 50,
    dutyPrice: 82818,
  ...
  {
    id: "bichup",
    catalogId: "whoo-bichup-essence",
    brand: "더후",
    name: "비첩 자생 에센스",
    image: "/products/whoo-bichup-essence.jpg",
    imageAlt: "더후 비첩 자생 에센스 제품",
    imageSource:
      "https://thewhoo.com/product/detail.html?product_no=619",
    unit: "ml",
    dutyVolume: 50,
    retailVolume: 50,
    dutyPrice: 102418,
    retailBasePrice: 165000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "cheongidan",
    catalogId: "whoo-cheongidan-cream",
    brand: "더후",
    name: "천기단 화현 래디언스크림",
    image: "/products/whoo-cheongidan-cream.jpg",
    imageAlt: "더후 천기단 화현 래디언스크림 제품",
    imageSource:
      "https://thewhoo.com/product/detail.html?product_no=837",
    unit: "ml",
    dutyVolume: 60,
    retailVolume: 60,
    dutyPrice: 324370,
    retailBasePrice: 365000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "yunjo",
    catalogId: "sulwhasoo-first-care-essence",
    brand: "설화수",
    name: "윤조에센스 6세대",
    image: "/products/sulwhasoo-first-care-essence.jpg",
    imageAlt: "설화수 윤조에센스 6세대 제품",
    imageSource:
      "https://sulwhasoo.com/product/%EC%9C%A4%EC%A1%B0%EC%97%90%EC%84%BC%EC%8A%A4-6%EC%84%B8%EB%8C%80/38/",
    unit: "ml",
    dutyVolume: 90,
    retailVolume: 90,
    dutyPrice: 79781,
    retailBasePrice: 150000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
    ...
    // 면세 100ml 점보 vs 국내 주력 40ml
  {
    id: "cicalfate",
    catalogId: "avene-cicalfate-plus",
    brand: "아벤느",
    name: "시칼파트 플러스 SOS 크림",
    image: "/products/avene-cicalfate-plus.png",
    imageAlt: "아벤느 시칼파트 플러스 SOS 크림 제품",
    imageSource:
      "https://www.eau-thermale-avene.co.kr/p/sikalpateu-peulreoseu-ripeeoring-peurotegtibeu-keurim-3282770204667-dc3af3fd",
    unit: "ml",
    dutyVolume: 100,
    retailVolume: 40,
    dutyPrice: 40028,
    retailBasePrice: 22000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "plankton",
    catalogId: "biotherm-life-plankton-essence",
    brand: "비오템",
    name: "라이프 플랑크톤 온천수 에센스",
    image: "/products/biotherm-life-plankton-essence.jpg",
    imageAlt: "비오템 라이프 플랑크톤 온천수 에센스 제품",
    imageSource:
      "https://www.biotherm.com/p/life-plankton-essence/14759217/",
    unit: "ml",
    dutyVolume: 200,
    retailVolume: 200,
    dutyPrice: 103522,
    retailBasePrice: 130000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
    ...
    // 면세 100ml vs 국내 본품 75ml
  {
    id: "aquapower",
    catalogId: "biotherm-homme-aquapower",
    brand: "비오템 옴므",
    name: "아쿠아파워 모이스춰라이저",
    image: "/products/biotherm-homme-aquapower.jpg",
    imageAlt: "비오템 옴므 아쿠아파워 모이스춰라이저 제품",
    imageSource:
      "https://www.biotherm.com/p/aquapower-72-hour-moisiturizer/14759222/",
    unit: "ml",
    dutyVolume: 100,
    retailVolume: 75,
    dutyPrice: 80057,
    retailBasePrice: 52000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "doubleserum",
    catalogId: "clarins-double-serum",
    brand: "클라랑스",
    name: "더블세럼",
    image: "/products/clarins-double-serum.jpg",
    imageAlt: "클라랑스 더블세럼 제품",
    imageSource:
      "https://clarins.co.kr/%ED%8E%98%EC%9D%B4%EC%8A%A4-%EB%B0%94%EB%94%94-%EC%BC%80%EC%96%B4/%ED%8E%98%EC%9D%B4%EC%8A%A4/%EC%84%B8%EB%9F%BC-240/%EB%8D%94%EB%B8%94-%EC%84%B8%EB%9F%BC-%EC%BB%B4%ED%94%8C%EB%A6%AC%ED%8A%B8-%EC%97%90%EC%9D%B4%EC%A7%80-%EC%BB%A8%ED%8A%B8%EB%A1%A4-%EC%BD%98%EC%84%BC%ED%8A%B8%EB%A0%88%EC%9D%B4%ED%8A%B8-C070400090.html",
    unit: "ml",
    dutyVolume: 50,
    retailVolume: 50,
    dutyPrice: 175298,
    retailBasePrice: 190000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "anthelios",
    catalogId: "lrp-anthelios-uvmune",
    brand: "라로슈포제",
    name: "안뗄리오스 UV뮨 400 SPF50+",
    image: "/products/lrp-anthelios-uvmune.png",
    imageAlt: "라로슈포제 안뗄리오스 UV뮨 400 SPF50+ 제품",
    imageSource:
      "https://www.larocheposay.co.kr/product/view/4175.do",
    unit: "ml",
    dutyVolume: 50,
    retailVolume: 50,
    dutyPrice: 33127,
    retailBasePrice: 35000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
    ...
    // 조사 시점 면세 일시품절 — 재입고 후 등록
  {
    id: "effaclar",
    catalogId: "lrp-effaclar-serum",
    brand: "라로슈포제",
    name: "에빠끌라 울트라 컨센트레이트 세럼",
    image: "/products/lrp-effaclar-serum.png",
    imageAlt: "라로슈포제 에빠끌라 울트라 컨센트레이트 세럼 제품",
    imageSource:
      "https://www.larocheposay.co.kr/product/view/4415.do",
    unit: "ml",
    dutyVolume: 30,
    retailVolume: 30,
    dutyPrice: 44169,
    retailBasePrice: 48000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "redsoothing",
    catalogId: "physiogel-red-soothing-cream",
    brand: "피지오겔",
    name: "레드수딩 AI 리페어 크림",
    image: "/products/physiogel-red-soothing-cream.jpg",
    imageAlt: "피지오겔 레드수딩 AI 리페어 크림 제품",
    imageSource:
      "https://physiogel.co.kr/product/%ED%94%BC%EC%A7%80%EC%98%A4%EA%B2%94-%EB%A0%88%EB%93%9C%EC%88%98%EB%94%A9-ai-%EC%86%90%EC%83%81%EC%9E%A5%EB%B2%BD-%EB%A6%AC%ED%8E%98%EC%96%B4-%EC%A7%84%EC%A0%95%ED%81%AC%EB%A6%BC-100ml/1048/",
    unit: "ml",
    dutyVolume: 100,
    retailVolume: 100,
    dutyPrice: 27606,
    retailBasePrice: 29900,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "pureoil",
    catalogId: "manyo-pure-cleansing-oil",
    brand: "마녀공장",
    name: "퓨어 클렌징 오일",
    image: "/products/manyo-pure-cleansing-oil.png",
    imageAlt: "마녀공장 퓨어 클렌징 오일 제품",
    imageSource:
  ...
  {
    id: "numbuzin5",
    catalogId: "numbuzin-no5-toner",
    brand: "넘버즈인",
    name: "5번 글루타치온C 비타수액 에센셜토너",
    image: "/products/numbuzin-no5-toner.jpg",
    imageAlt: "넘버즈인 5번 글루타치온C 비타수액 에센셜토너 제품",
    imageSource:
      "https://us.numbuzin.com/products/no-5-vitamin-boosting-essential-toner",
    unit: "ml",
    dutyVolume: 200,
    retailVolume: 200,
    dutyPrice: 20704,
    retailBasePrice: 24900,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "abibtoner",
    catalogId: "abib-heartleaf-toner",
    brand: "아비브",
    name: "어성초 카밍 토너 스킨 부스터",
    image: "/products/abib-heartleaf-toner.jpg",
    imageAlt: "아비브 어성초 카밍 토너 스킨 부스터 제품",
    imageSource:
      "https://abib.com/product/detail.html?product_no=133&cate_no=72&display_group=1",
    unit: "ml",
    dutyVolume: 200,
    retailVolume: 200,
    dutyPrice: 11620,
    retailBasePrice: 20000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "narspowder",
    catalogId: "nars-light-reflecting-powder",
    brand: "나스",
    name: "라이트 리플렉팅 세팅 파우더 루스",
    image: "/products/nars-light-reflecting-powder.png",
    imageAlt: "나스 라이트 리플렉팅 세팅 파우더 루스 제품",
    imageSource:
      "https://www.narscosmetics.com/USA/light-reflecting-loose-setting-powder/999NAC0000098.html",
    unit: "g",
    dutyVolume: 11,
    retailVolume: 11,
    dutyPrice: 59352,
    retailBasePrice: 68000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
    ...
    // 면세 12g vs 국내 15g — 단위가 비교
  {
    id: "macstudiofix",
    catalogId: "mac-studio-fix-powder",
    brand: "맥",
    name: "스튜디오 픽스 파우더 플러스 파운데이션",
    image: "/products/mac-studio-fix-powder.png",
    imageAlt: "맥 스튜디오 픽스 파우더 플러스 파운데이션 제품",
    imageSource:
      "https://www.maccosmetics.com/products/studio-fix-powder-plus-foundation",
    unit: "g",
    dutyVolume: 12,
    retailVolume: 15,
    dutyPrice: 63493,
    retailBasePrice: 73000,
    shipping: 0,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "herauv",
    catalogId: "hera-uv-protector",
    brand: "헤라",
    name: "UV프로텍터 멀티디펜스 EX",
    image: "/products/hera-uv-protector.jpg",
    imageAlt: "헤라 UV프로텍터 멀티디펜스 EX 제품",
    imageSource:
      "https://www.hera.com/product/uv%ED%94%84%EB%A1%9C%ED%85%8D%ED%84%B0-%EB%A9%80%ED%8B%B0%EB%94%94%ED%8E%9C%EC%8A%A4-spf50pa/142/category/43/display/1/",
    unit: "ml",
    dutyVolume: 50,
    retailVolume: 50,
    dutyPrice: 38648,
    retailBasePrice: 45000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
  ...
  {
    id: "ahcstick",
    catalogId: "ahc-airrich-sunstick",
    brand: "AHC",
    name: "마스터즈 에어리치 선스틱",
    image: "/products/ahc-airrich-sunstick.jpg",
    imageAlt: "AHC 마스터즈 에어리치 선스틱 제품",
    imageSource:
      "https://www.ahc.co.kr/shop/product/productView?prdIdx=3958",
    unit: "g",
    dutyVolume: 22,
    retailVolume: 22,
    dutyPrice: 20705,
    retailBasePrice: 15000,
    shipping: 2500,
    dutyCondition: "예시 공개가 · 출국장 수령",
    retailSource: "국내 리테일 예시",
    retailCondition: "예시 일반배송 · 배송비 포함",
