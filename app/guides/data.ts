...
export const guideArticles: GuideArticle[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "단위가격 차이가 크지 않다면 배송 속도, 선물 포장, 반품 가능 여부도 비용으로 볼 수 있습니다. 체리피커는 이런 조건을 가격 옆에 함께 표시해 숫자 하나만으로 구매를 유도하지 않는 방향을 지향합니다.",
    ],
  ...
  },
  {
    ...
    verdict: "부드럽고 달콤한 스타일을 선호한다면 면세와 국내 픽업의 가격 차이를 함께 확인해보세요.",
    summary:
  ...
  },
  {
    ...
    verdict: "건과일과 초콜릿 계열 취향인지 확인한 뒤 100ml 가격을 비교해보세요.",
    summary:
