...
export const metadata: Metadata = {
  title: "서비스 소개 — 살까?",
  description:
    "면세점과 국내 리테일 가격을 동일한 용량과 실제 결제가 기준으로 비교하는 살까?의 운영 목적을 소개합니다.",
};

export default function AboutPage() {
  return (
    <StaticPage
      eyebrow="ABOUT SALKKA"
      title="가격을 같은 기준으로 바꾸는 서비스"
      description="살까?는 면세가가 정말 저렴한지, 국내에서 바로 사는 편이 나은지를 설명하는 구매 판단 도구입니다."
    >
      <section>
        <h2>왜 만들었나요?</h2>
        <p>
        ...
        <p>
          살까?는 최종 결제가와 ml·g·개당 가격을 함께 보여주고, 같은 용량으로
          환산한 절감액을 계산합니다. 주류는 가격뿐 아니라 단맛, 스모키함,
          바디감처럼 취향 실패를 줄이는 정보도 제공합니다.
        </p>
      </section>
